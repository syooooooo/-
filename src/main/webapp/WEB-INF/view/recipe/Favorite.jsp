...
<%@ page import="utils.RecipeDAO" %>
<%@ page import="java.util.List" %>
<%@ page import="utils.FavoriteBean" %>
...
<div class="body">
    ...
    <div class="results">
        ...
        <%
            // レシピリストの取得とチェック
            List<FavoriteBean> recipes = (List<FavoriteBean>) request.getAttribute("recipes");
            String userId = (String) session.getAttribute("user_id");
            if (recipes == null || recipes.isEmpty()) {
        %>
        <p>現在、表示できるレシピはありません。</p>
        <% } else {
            for (FavoriteBean recipe : recipes) {
        ...
        <a href="RecipeDetailServlet?recipeId=<%= recipe.getId() %>" class="recipe-card <%= recipeClass %>">
            <%--        <img src="<%= recipe.getImagePath() %>" alt="レシピ画像">--%>
<%--            <img src="#" alt="レシピ画像">--%>
